...
def test_field_equal_to_none_raw():
    condition: Condition = field == None
    assert condition.sql == "table.column IS NULL"


def test_field_equal_to_none():
    condition: Condition = Table.column == None
    assert condition.sql == "table.column IS NULL"


def test_field_equal_to_other_field_raw():
