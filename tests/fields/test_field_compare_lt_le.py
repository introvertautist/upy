...
def test_field_lt_to_other_field_raw():
...
def test_field_lt_to_other_field():
...
def test_field_lt_to_expression_raw():
...
def test_field_lt_to_expression_field():
...
def test_field_lt_to_primitive_raw():
...
def test_field_lt_to_primitive():
